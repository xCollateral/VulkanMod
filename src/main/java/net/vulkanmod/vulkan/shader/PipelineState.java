...
//            this(true, glToVulkanBlendFactor(srcRgb.value), glToVulkanBlendFactor(dstRgb.value),
//                    glToVulkanBlendFactor(srcAlpha.value), glToVulkanBlendFactor(dstAlpha.value), VK_BLEND_OP_ADD);
//        }
//
//        public BlendState(int srcRgb, int dstRgb, int srcAlpha, int dstAlpha) {
//            this(true, glToVulkanBlendFactor(srcRgb), glToVulkanBlendFactor(dstRgb), glToVulkanBlendFactor(srcAlpha), glToVulkanBlendFactor(dstAlpha), VK_BLEND_OP_ADD);
//        }
