...
public class ModelPartM {
    ...
    private void compile(PoseStack.Pose pose, VertexConsumer vertexConsumer, int i, int j, float r, float g, float b, float a) {
        Matrix4f matrix4f = Util.convertMatrix(pose.pose());
        Matrix3f matrix3f = Util.convertMatrix(pose.normal());
...
//            int var12 = var11.length;
            ...
            for (ModelPart.Polygon polygon : var11) {
                Vector3f vector3f = matrix3f.transform(new Vector3f(polygon.normal.x(), polygon.normal.y(), polygon.normal.z()));
//                float l = vector3f.x();
//                float m = vector3f.y();
//                float n = vector3f.z();
...
//                    vertexConsumer.vertex(vector4f.x(), vector4f.y(), vector4f.z(), r, g, b, a, vertex.u, vertex.v, j, i, l, m, n);
                    ...
                    com.mojang.math.Vector3f pos = vertex.pos;
